...
/**
 * Wrapper on java.mysql.Connection.
 */
public class WrapperConnection {
     ...
     *
     * @throws SQLException if a database access erroUndoes all changes made in the current transaction and releases any database locks currently held by this
     * WrapperConnection object. This method should be used only when auto-commit mode has been disabled.r occurs, this method is called while participating in a
