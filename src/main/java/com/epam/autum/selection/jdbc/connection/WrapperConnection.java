...
public class WrapperConnection {
    private static final Logger log = LogManager.getLogger(WrapperConnection.class);
    ...
    /**
     * Releases Statement object's jdbc and JDBC resources immediately instead of waiting for this to happen when it is automatically closed.
     *
    ...
    /**
     * Releases this Connection object's jdbc and JDBC resources immediately instead of waiting for them to be automatically released.
     */
    ...
    /**
     * Creates a PreparedStatement object for sending parameterized SQL statements to the jdbc.
     *
     ...
     * @throws SQLException if a jdbc access error occurs, setAutoCommit(true) is called while participating in a
    ...
    /**
     * Undoes all changes made in the current transaction and releases any jdbc locks currently held by this
     * WrapperConnection object. This method should be used only when auto-commit mode has been disabled.
     *
     * @throws SQLException if a jdbc access error occurs, this method is called while participating in a
    ...
    /**
     * Makes all changes made since the previous commit/rollback permanent and releases any jdbc locks currently
